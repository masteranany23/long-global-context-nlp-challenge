# src/predict_retry.py
# Retry pipeline for failed rows only - outputs to results_retry.csv
...
DATA_DIR = "./data"
INDEX_DIR = "./indexes"
RESULTS_FILE = "results_retry.csv"  # Output to separate file
...
test_file = Path(DATA_DIR) / "test_retry.csv"  # Use retry subset
...
# Run the computation
print("\nRunning retry pipeline for failed rows...")
